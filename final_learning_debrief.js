(function(){
  ...
  function renderHtml(report,summary){
    ...
    return `<div class="micro-note">${status}。early→lateの同一contractから記述的に要約します。臨床能力の合否判定ではありません。</div>
      ...
      <div class="micro-note" style="margin-top:8px"><b>次に見る処方課題：</b>${remain||'方向別rapid/basal biasに明確な悪化なし'}</div>`;
  }
  ...
  window.WardFinalLearningDebrief={build,analyze,renderHtml,refresh,classifyMetric,TARGET_CASES,version:'1.0.0'};
