...
(function(root){
  ...
  function installStyles(){
    ...
    style.textContent=`
      ...
      .dose-input-card.${TARGET_CLASS}[data-actionable-direction="↑"] .dose-step-btn:nth-child(n+3),
      .dose-input-card.${TARGET_CLASS}[data-actionable-direction="↓"] .dose-step-btn:nth-child(-n+2){outline:2px solid currentColor;outline-offset:-2px;font-weight:950;background:#fff}
      .dose-input-card.${TARGET_CLASS}[data-actionable-direction="↑"] .dose-step-btn:nth-child(-n+2),
      .dose-input-card.${TARGET_CLASS}[data-actionable-direction="↓"] .dose-step-btn:nth-child(n+3){opacity:.48}
  ...
  const api={currentTarget,targetForTag,targetForObjective,currentDayKey,resultIsVisible,autoFocusTarget,applyTarget,evidenceForCarry,semanticRuleForTag,doseUiTargets,tagTargets,objectiveDoseTargets,version:'1.10.0'};
