...
function simulateCourse(baseModel,dynamicModel,p,initialOrder,config={},seed=1){
 ...
 for(let d=0;d<days;d++){
   ...
   course.records.push({day:d+1,state,order:copyOrder(order),effective_basal_u:effectiveBasal,insulin_exposure_multiplier:sim.insulin_exposure_multiplier,bolus_kernel:sim.bolus_kernel,rescue_kernel:sim.rescue_kernel||null,bedtime_corrections:sim.bedtime_corrections||[],prandial_safety_adjustments:sim.prandial_safety_adjustments||[],hypoglycemia_rescues:sim.hypoglycemia_rescues||[],bg,end_glucose:sim.end,series:sim.series});
...
window.T2DMInpatientCourseV1Exp={version:'0.8-record-prandial-safety-adjustments-2026-08-21',simulateCourse,titrateOrder};
})();
