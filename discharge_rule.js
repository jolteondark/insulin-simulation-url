(function(){
  ...
  function mount(){
    ...
    // app.js installs its onclick handler before this module mounts. This listener
    // therefore runs after the simulated day is committed, without timer ordering.
    submit.addEventListener('click',processLatest);
  }

  window.DischargeRule={stableScaleFreeDay,consecutiveStableScaleFreeDays,eligible,progressText,processLatest,version:'1.1.0'};
